 ...
 *
 * <p>模式计数 = 8（cot + react + selfAsk + planExecute + tot + reflexion + roleplay + mock），
 * Phase 10 新增 roleplay。
 */
...
class PatternControllerWithMockTest {
    ...
    void shouldReturnMockPatternWhenComponentRegistered() {
        ...
        // planExecute（Phase 7）、tot（Phase 8）、reflexion（Phase 9）、roleplay（Phase 10）
        // 和 mock 的模式列表
